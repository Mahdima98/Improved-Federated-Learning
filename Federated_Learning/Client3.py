...
data = pd.read_csv('Data3\data3_NMF_train.csv',low_memory=False)

X_train=data[['nmf1', 'nmf2', 'nmf3', 'nmf4', 'nmf5','nmf6','nmf7','nmf8']]
y_train=data[['category']]

test = pd.read_csv('Data3\data3_NMF_test.csv')
...
# data = pd.read_csv('Data3\data3_ICA_train.csv',low_memory=False)

# X_train=data[['ICA1', 'ICA2', 'ICA3', 'ICA4', 'ICA5','ICA6','ICA7','ICA8']]
# y_train=data[['category']]

# test = pd.read_csv('Data3\data3_ICA_test.csv')
